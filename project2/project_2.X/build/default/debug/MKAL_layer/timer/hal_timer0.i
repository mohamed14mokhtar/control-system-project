# 1 "MKAL_layer/timer/hal_timer0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MKAL_layer/timer/hal_timer0.c" 2
...
# 1 "MKAL_layer/timer/../mkal_std_types.h" 1
# 11 "MKAL_layer/timer/../mkal_std_types.h"
# 1 "MKAL_layer/timer/../compiler.h" 1
# 12 "MKAL_layer/timer/../compiler.h"
...
# 12 "MKAL_layer/timer/../compiler.h" 2
# 11 "MKAL_layer/timer/../mkal_std_types.h" 2

# 1 "MKAL_layer/timer/../std_library.h" 1
# 13 "MKAL_layer/timer/../std_library.h"
...
# 13 "MKAL_layer/timer/../std_library.h" 2
...
# 15 "MKAL_layer/timer/../std_library.h" 2
# 12 "MKAL_layer/timer/../mkal_std_types.h" 2
...
# 12 "MKAL_layer/timer/hal_timer0.h" 2


# 1 "MKAL_layer/timer/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/timer/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/timer/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/timer/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/timer/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MKAL_layer/timer/../Interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MKAL_layer/timer/../Interrupt/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/timer/../Interrupt/../gpio/pro_gpio.h"
# 1 "MKAL_layer/timer/../Interrupt/../gpio/../device_config.h" 1
# 14 "MKAL_layer/timer/../Interrupt/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/timer/../Interrupt/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 12 "MKAL_layer/timer/../Interrupt/mcal_interrupt_gen_cfg.h" 2
# 42 "MKAL_layer/timer/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/timer/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/timer/../Interrupt/mcal_internal_interrupt.h" 2
# 14 "MKAL_layer/timer/hal_timer0.h" 2
...
# 8 "MKAL_layer/timer/hal_timer0.c" 2
...
# 58 "MKAL_layer/timer/hal_timer0.c"
        (INTCONbits.GIE =1);
        (INTCONbits.PEIE =1);
        (INTCONbits.TMR0IE = 1);
        (INTCONbits.TMR0IF = 0);
...
static void timer0_prescaler_cfg(const Timer0_t *Timer0){
    if(Timer0->prescaler_enable == 0){
        (T0CONbits.PSA =0);
        T0CONbits.T0PS = Timer0->Prescaler_Select;
    }
    else if(Timer0->prescaler_enable == 1){
        (T0CONbits.PSA =1);
    }
    else{}
}
...
static void timer0_mode (const Timer0_t *Timer0){
    if(Timer0->timer0_mode == 1){
        (T0CONbits.T0CS =1);
        if(Timer0->timer0_counter_edge == 1){
            (T0CONbits.T0SE =1);
        }
        else if(Timer0->timer0_counter_edge == 0){
            (T0CONbits.T0SE =0);
        }
        else{}
    }
    else if(Timer0->timer0_mode == 0){
        (T0CONbits.T0CS =0);
    }
    else{}
}
...
static void timer0_register_size(const Timer0_t *Timer0){
    if(Timer0->timer0_register_size == 1){
        (T0CONbits.T08BIT =1);
    }
    else if(Timer0->timer0_register_size == 0){
        (T0CONbits.T08BIT =0);
    }
    else{}
}
