# 1 "MKAL_layer/timer3/hal_timer3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MKAL_layer/timer3/hal_timer3.c" 2
...
# 1 "MKAL_layer/timer3/../mkal_std_types.h" 1
# 11 "MKAL_layer/timer3/../mkal_std_types.h"
# 1 "MKAL_layer/timer3/../compiler.h" 1
# 12 "MKAL_layer/timer3/../compiler.h"
...
# 12 "MKAL_layer/timer3/../compiler.h" 2
# 11 "MKAL_layer/timer3/../mkal_std_types.h" 2

# 1 "MKAL_layer/timer3/../std_library.h" 1
# 13 "MKAL_layer/timer3/../std_library.h"
...
# 13 "MKAL_layer/timer3/../std_library.h" 2
...
# 15 "MKAL_layer/timer3/../std_library.h" 2
# 12 "MKAL_layer/timer3/../mkal_std_types.h" 2
...
# 13 "MKAL_layer/timer3/hal_timer3.h" 2


# 1 "MKAL_layer/timer3/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/timer3/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/timer3/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/timer3/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/timer3/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MKAL_layer/timer3/../Interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MKAL_layer/timer3/../Interrupt/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/timer3/../Interrupt/../gpio/pro_gpio.h"
# 1 "MKAL_layer/timer3/../Interrupt/../gpio/../device_config.h" 1
# 14 "MKAL_layer/timer3/../Interrupt/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/timer3/../Interrupt/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 12 "MKAL_layer/timer3/../Interrupt/mcal_interrupt_gen_cfg.h" 2
# 42 "MKAL_layer/timer3/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/timer3/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/timer3/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MKAL_layer/timer3/hal_timer3.h" 2
...
# 8 "MKAL_layer/timer3/hal_timer3.c" 2
...
# 45 "MKAL_layer/timer3/hal_timer3.c"
        (INTCONbits.GIE =1);
        (INTCONbits.PEIE =1);
...
static void timer3_mode_cfg(const Timer3_t *Timer3){
    if(Timer3->timer3_mode == 0){
        ...
        (T3CONbits.TMR3CS =1);
        if(Timer3->timer3_counter_mode == 1){
            (T3CONbits.nT3SYNC =1);
        }
        else if(Timer3->timer3_counter_mode == 0){
            (T3CONbits.nT3SYNC =0);
        }
        else{ }
    }
...
static void timer3_reg_bit_cfg (const Timer3_t *Timer3){
    if(Timer3->timer3_wr__reg_cfg == 0){
        (T3CONbits.RD16 =0);
    }
    else if(Timer3->timer3_wr__reg_cfg == 1){
        (T3CONbits.RD16 =1);
    }
    else { }
}
