# 1 "MKAL_layer/timer2/hal_timer2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MKAL_layer/timer2/hal_timer2.c" 2
...
# 1 "MKAL_layer/timer2/../mkal_std_types.h" 1
# 11 "MKAL_layer/timer2/../mkal_std_types.h"
# 1 "MKAL_layer/timer2/../compiler.h" 1
# 12 "MKAL_layer/timer2/../compiler.h"
...
# 12 "MKAL_layer/timer2/../compiler.h" 2
# 11 "MKAL_layer/timer2/../mkal_std_types.h" 2

# 1 "MKAL_layer/timer2/../std_library.h" 1
# 13 "MKAL_layer/timer2/../std_library.h"
...
# 13 "MKAL_layer/timer2/../std_library.h" 2
...
# 15 "MKAL_layer/timer2/../std_library.h" 2
# 12 "MKAL_layer/timer2/../mkal_std_types.h" 2
...
# 13 "MKAL_layer/timer2/hal_timer2.h" 2


# 1 "MKAL_layer/timer2/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/timer2/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/timer2/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/timer2/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/timer2/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MKAL_layer/timer2/../Interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MKAL_layer/timer2/../Interrupt/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/timer2/../Interrupt/../gpio/pro_gpio.h"
# 1 "MKAL_layer/timer2/../Interrupt/../gpio/../device_config.h" 1
# 14 "MKAL_layer/timer2/../Interrupt/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/timer2/../Interrupt/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 12 "MKAL_layer/timer2/../Interrupt/mcal_interrupt_gen_cfg.h" 2
# 42 "MKAL_layer/timer2/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/timer2/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/timer2/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MKAL_layer/timer2/hal_timer2.h" 2
...
# 8 "MKAL_layer/timer2/hal_timer2.c" 2
...
Std_ReturnType Timer2_init (const Timer2_t *Timer2){
    ...
    {
        (T2CONbits.TMR2ON = 0);
        (T2CONbits.T2CKPS = Timer2->timer2_prescaler_cfg);;
        (T2CONbits.TOUTPS = Timer2->timer2_postscaler_cfg);;
...
# 42 "MKAL_layer/timer2/hal_timer2.c"
        (INTCONbits.GIE =1);
        (INTCONbits.PEIE =1);
