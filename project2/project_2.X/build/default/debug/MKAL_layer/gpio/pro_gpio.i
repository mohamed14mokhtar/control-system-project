...
# 2 "<built-in>" 2
# 1 "MKAL_layer/gpio/pro_gpio.c" 2
...
# 1 "MKAL_layer/gpio/pro_gpio.h" 1
# 13 "MKAL_layer/gpio/pro_gpio.h"
# 1 "MKAL_layer/gpio/../mkal_std_types.h" 1
# 11 "MKAL_layer/gpio/../mkal_std_types.h"
# 1 "MKAL_layer/gpio/../compiler.h" 1
# 12 "MKAL_layer/gpio/../compiler.h"
...
# 12 "MKAL_layer/gpio/../compiler.h" 2
# 11 "MKAL_layer/gpio/../mkal_std_types.h" 2

# 1 "MKAL_layer/gpio/../std_library.h" 1
# 13 "MKAL_layer/gpio/../std_library.h"
...
# 13 "MKAL_layer/gpio/../std_library.h" 2
...
# 15 "MKAL_layer/gpio/../std_library.h" 2
# 12 "MKAL_layer/gpio/../mkal_std_types.h" 2
...
# 13 "MKAL_layer/gpio/pro_gpio.h" 2

# 1 "MKAL_layer/gpio/../device_config.h" 1
# 14 "MKAL_layer/gpio/pro_gpio.h" 2
# 36 "MKAL_layer/gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 7 "MKAL_layer/gpio/pro_gpio.c" 2
...
Std_ReturnType GPIO_pIN_DIRECTION_INTIALIZE(const pin_config_t *config_pin)
{
    ...
    if ((((void*)0) == config_pin) || (config_pin->pin > 8 -1)){
        ret =(Std_ReturnType)0x00;
    }
    else{
        switch (config_pin->direction){
            case GPIO_OUTPUT :
                (*tris_regisrers[config_pin->port] &= ~((uint8)1 << config_pin->pin));
                break;
            case GPIO_INPUT :
                (*tris_regisrers[config_pin->port] |= ((uint8)1 << config_pin->pin));
                break;
...
{
    Std_ReturnType ret =(Std_ReturnType)0x01;
    if ((((void*)0) == config_pin) || (config_pin->pin > 8 -1) || (((void*)0) == dirction)){
        ret =(Std_ReturnType)0x00;
    }
    else{
        *dirction=((*tris_regisrers[config_pin->port] >> config_pin->pin) & (uint8)1);
    }
    return ret;
}
...
Std_ReturnType GPIO_pIN_WRITE_LOGIC(const pin_config_t *config_pin ,logic_t logic)
{
    ...
    if ((((void*)0) == config_pin) || (config_pin->pin > 8 -1)){
        ...
        switch (logic){
            case GPIO_LOW:
                (*lat_regisrers[config_pin->port] &= ~((uint8)1 << config_pin->pin));
                break;
            case GPIO_HIGH :
                (*lat_regisrers[config_pin->port] |= ((uint8)1 << config_pin->pin));
                break;
...
{
    Std_ReturnType ret =(Std_ReturnType)0x01;
    if ((((void*)0) == config_pin) || (config_pin->pin > 8 -1) || (((void*)0) == logic)){
        ret =(Std_ReturnType)0x00;
    }
    else{
        *logic =((*port_regisrers[config_pin->port] >> config_pin->pin) & (uint8)1);
    }
    return ret;
}
...
{
    Std_ReturnType ret =(Std_ReturnType)0x01;
    if ((((void*)0) == dirction_status) || (port > 5 -1)){
        ret =(Std_ReturnType)0x00;
    }
    else{
