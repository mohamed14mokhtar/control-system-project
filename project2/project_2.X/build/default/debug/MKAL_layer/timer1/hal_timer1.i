# 1 "MKAL_layer/timer1/hal_timer1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MKAL_layer/timer1/hal_timer1.c" 2
...
# 1 "MKAL_layer/timer1/../mkal_std_types.h" 1
# 11 "MKAL_layer/timer1/../mkal_std_types.h"
# 1 "MKAL_layer/timer1/../compiler.h" 1
# 12 "MKAL_layer/timer1/../compiler.h"
...
# 12 "MKAL_layer/timer1/../compiler.h" 2
# 11 "MKAL_layer/timer1/../mkal_std_types.h" 2

# 1 "MKAL_layer/timer1/../std_library.h" 1
# 13 "MKAL_layer/timer1/../std_library.h"
...
# 13 "MKAL_layer/timer1/../std_library.h" 2
...
# 15 "MKAL_layer/timer1/../std_library.h" 2
# 12 "MKAL_layer/timer1/../mkal_std_types.h" 2
...
# 13 "MKAL_layer/timer1/hal_timer1.h" 2


# 1 "MKAL_layer/timer1/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/timer1/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/timer1/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/timer1/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/timer1/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MKAL_layer/timer1/../Interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MKAL_layer/timer1/../Interrupt/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/timer1/../Interrupt/../gpio/pro_gpio.h"
# 1 "MKAL_layer/timer1/../Interrupt/../gpio/../device_config.h" 1
# 14 "MKAL_layer/timer1/../Interrupt/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/timer1/../Interrupt/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 12 "MKAL_layer/timer1/../Interrupt/mcal_interrupt_gen_cfg.h" 2
# 42 "MKAL_layer/timer1/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/timer1/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/timer1/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MKAL_layer/timer1/hal_timer1.h" 2
...
# 8 "MKAL_layer/timer1/hal_timer1.c" 2
...
# 57 "MKAL_layer/timer1/hal_timer1.c"
        (INTCONbits.GIE =1);
        (INTCONbits.PEIE =1);
...
static void timer1_mode_cfg (const Timer1_t *Timer1){
    if(Timer1->timer1_mode == 1){
         (T1CONbits.TMR1CS =1);
        if(Timer1->timer1_counter_mode == 1){
            (T1CONbits.nT1SYNC =1);
        }
        else if(Timer1->timer1_counter_mode == 0){
            (T1CONbits.nT1SYNC =0);
        }
         else{ }
    }
...
static void timer1_reg_bit_cfg (const Timer1_t *Timer1){
    if(Timer1->timer1_wr__reg_cfg == 0){
        (T1CONbits.RD16 =0);
    }
    else if(Timer1->timer1_wr__reg_cfg == 1){
        (T1CONbits.RD16 =1);
    }
    else { }
}
...
static void timer1_osc_cfg (const Timer1_t *Timer1){
    if(Timer1->timer1_osc_cfg == 1){
        (T1CONbits.T1OSCEN =1);
    }
    else if(Timer1->timer1_osc_cfg == 0){
        (T1CONbits.T1OSCEN =0);
    }
    else { }
}
