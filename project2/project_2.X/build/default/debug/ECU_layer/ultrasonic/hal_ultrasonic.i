# 1 "ECU_layer/ultrasonic/hal_ultrasonic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_layer/ultrasonic/hal_ultrasonic.c" 2
...
# 1 "ECU_layer/ultrasonic/hal_ultasonic.h" 1
# 11 "ECU_layer/ultrasonic/hal_ultasonic.h"
# 1 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/pro_gpio.h" 1
# 13 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/pro_gpio.h"
# 1 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../mkal_std_types.h" 1
# 11 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../mkal_std_types.h"
# 1 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../compiler.h" 1
# 12 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../compiler.h"
...
# 12 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../compiler.h" 2
# 11 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../mkal_std_types.h" 2

# 1 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../std_library.h" 1
# 13 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../std_library.h"
...
# 13 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../std_library.h" 2
...
# 15 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../std_library.h" 2
# 12 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../mkal_std_types.h" 2
...
# 13 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/pro_gpio.h" 2

# 1 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/../device_config.h" 1
# 14 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/pro_gpio.h" 2
# 36 "ECU_layer/ultrasonic/../../MKAL_layer/gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 11 "ECU_layer/ultrasonic/hal_ultasonic.h" 2

# 1 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/hal_timer1.h" 1
# 12 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/hal_timer1.h"
# 1 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/hal_timer1_cfg.h" 1
# 12 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/hal_timer1.h" 2



# 1 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_internal_interrupt.h"
# 1 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_interrupt_config.h" 1
# 14 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_interrupt_config.h"
# 1 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 42 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_interrupt_config.h" 2
# 12 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/hal_timer1.h" 2
# 65 "ECU_layer/ultrasonic/../../MKAL_layer/timer1/hal_timer1.h"
typedef struct {
...
# 12 "ECU_layer/ultrasonic/hal_ultasonic.h" 2
...
uint16 return_distance( ulta_t *ulta);
void initilized (ulta_t *ulta);
# 8 "ECU_layer/ultrasonic/hal_ultrasonic.c" 2


uint16 return_distance(ulta_t *ulta){
    uint16 value =0;
        ulta->TR_PIN.logic=GPIO_HIGH;
        _delay((unsigned long)((15)*(4000000UL/4000.0)));
        ulta->TR_PIN.logic=GPIO_LOW;

        TMR1 =0;
        while(RC6){
           uint8 l_tmr1_l= TMR1L;
           uint8 l_tmr1_h= TMR1H;
        value = TMR1;
        }
        return value;
}
...
void initilized (ulta_t *ulta){
    GPIO_pIN_INTIALIZE(&(ulta->TR_PIN));
    GPIO_pIN_INTIALIZE(&(ulta->ECHO_PIN));
}
