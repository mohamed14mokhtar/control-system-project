...
void MSSP_I2C_Master_call_slave_read(const mssp_i2c_t *i2c_obj, uint8 address,uint8 *data, uint8 *_ack);
...
# 14 "./ECU_layer/ultrasonic/hal_ultrasonic.h"
typedef struct {
...
.i2c_cfg.i2c_general_call=1,.i2c_cfg.i2c_master_rec_mode=0,
...
ccp1_t ccp1_={.CCP1_handler=((void*)0),.ccp1_mode=0x0E,.pin_config.port=PORTC_INDEX,.pin_config=pin2,
.pwm_frequence=5000,.timer2_postscaler_cfg=1,.timer2_prescaler_cfg=1,
.pin_config.direction=GPIO_OUTPUT};

Timer2_t Timer2_1 ={.Timer2_handler=((void*)0),
...
Timer1_t Timer1_1 ={.Timer1_handler=((void*)0),.timer1_mode=0,
                    .timer1_osc_cfg=0,.timer1_preload_value=0,
                    .timer1_prescaler_cfg=0,.timer1_wr__reg_cfg=0};
...
int main() {
    ...
    while(1)
    {
        ...
        tc74_read_value(&mssp_i2c,(uint8)0X9E,(uint8)0x00,&ret_data_1,&_ack);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        tc74_read_value(&mssp_i2c,0x9C,(uint8)0x00,&ret_data_2,&_ack);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        tc74_read_value(&mssp_i2c,0x98,(uint8)0x00,&ret_data_3,&_ack);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));


        if(ret_data_1 > 25){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'A',&_ack);
        }else{
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'C',&_ack);
        }


        if ((ret_data_3 > 30)){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'K',&_ack);
        }else if ((ret_data_3 < 30) && (ret_data_3 >= 27)){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'L',&_ack);
        }else if ((ret_data_3 < 27) && (ret_data_3 >= 25)){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'H',&_ack);
        }else if ((ret_data_3 < 25)){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'G',&_ack);
        }
        ...
        if(ret_data_2 > 40){
            while(ret_data_2 > 40){
                tc74_read_value(&mssp_i2c,0x9C,(uint8)0x00,&ret_data_2,&_ack);
                MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,ret_data_2,&_ack);
        ...
        if(data_key_1 == '1'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'Q',&_ack);
        }else if(data_key_1 == '2'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'W',&_ack);
        }else if(data_key_1 == '3'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'E',&_ack);
        }else if(data_key_1 == '4'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'R',&_ack);
        }else if(data_key_1 == '5'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'T',&_ack);
        }else if(data_key_1 == '6'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'Y',&_ack);
        }else if(data_key_1 == '7'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'U',&_ack);
        }else if(data_key_1 == '8'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'I',&_ack);
        }else if(data_key_1 == '9'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'O',&_ack);
        }else if(data_key_1 == '*'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'S',&_ack);
        }else if(data_key_1 == '*'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'S',&_ack);
        }else if(data_key_1 == '/'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'F',&_ack);
        }else if(data_key_1 == '-'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'J',&_ack);
        }else if(data_key_1 == '+'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'Z',&_ack);
        }else if(data_key_1 == '='){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'X',&_ack);
        }else if(data_key_1 == '0'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'V',&_ack);
        }else if(data_key_1 == '#'){
            MSSP_I2C_Master_call_slave(&mssp_i2c,0x60,'B',&_ack);
        }
