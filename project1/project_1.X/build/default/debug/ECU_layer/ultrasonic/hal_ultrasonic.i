...
# 1 "ECU_layer/ultrasonic/hal_ultrasonic.h" 1
# 11 "ECU_layer/ultrasonic/hal_ultrasonic.h"
...
# 11 "ECU_layer/ultrasonic/hal_ultrasonic.h" 2
...
# 12 "ECU_layer/ultrasonic/hal_ultrasonic.h" 2
...
void send_start(ultra_pins_t *ultra_pins){
    GPIO_pIN_WRITE_LOGIC(&(ultra_pins->trigger_pin),GPIO_HIGH);
    _delay((unsigned long)((10)*(4000000UL/4000000.0)));
    GPIO_pIN_WRITE_LOGIC(&(ultra_pins->trigger_pin),GPIO_LOW);
}
