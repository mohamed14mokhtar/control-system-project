...
# 13 "MKAL_layer/ADC/hal_adc.h" 2

# 1 "MKAL_layer/ADC/../mkal_std_types.h" 1
# 11 "MKAL_layer/ADC/../mkal_std_types.h"
# 1 "MKAL_layer/ADC/../compiler.h" 1
# 12 "MKAL_layer/ADC/../compiler.h"
...
# 12 "MKAL_layer/ADC/../compiler.h" 2
# 11 "MKAL_layer/ADC/../mkal_std_types.h" 2

# 1 "MKAL_layer/ADC/../std_library.h" 1
# 13 "MKAL_layer/ADC/../std_library.h"
...
# 13 "MKAL_layer/ADC/../std_library.h" 2
...
# 15 "MKAL_layer/ADC/../std_library.h" 2
# 12 "MKAL_layer/ADC/../mkal_std_types.h" 2
...
# 14 "MKAL_layer/ADC/hal_adc.h" 2

# 1 "MKAL_layer/ADC/../gpio/pro_gpio.h" 1
# 14 "MKAL_layer/ADC/../gpio/pro_gpio.h"
# 1 "MKAL_layer/ADC/../gpio/../device_config.h" 1
# 14 "MKAL_layer/ADC/../gpio/pro_gpio.h" 2
# 36 "MKAL_layer/ADC/../gpio/pro_gpio.h"
typedef enum {
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 15 "MKAL_layer/ADC/hal_adc.h" 2

# 1 "MKAL_layer/ADC/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MKAL_layer/ADC/../Interrupt/mcal_internal_interrupt.h"
# 1 "MKAL_layer/ADC/../Interrupt/mcal_interrupt_config.h" 1
# 14 "MKAL_layer/ADC/../Interrupt/mcal_interrupt_config.h"
# 1 "MKAL_layer/ADC/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 42 "MKAL_layer/ADC/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HUGH_PRIORITY
}INTERRUPT_PRIORITY_t;
# 14 "MKAL_layer/ADC/../Interrupt/mcal_interrupt_config.h" 2
# 12 "MKAL_layer/ADC/../Interrupt/mcal_internal_interrupt.h" 2
# 16 "MKAL_layer/ADC/hal_adc.h" 2
...
# 8 "MKAL_layer/ADC/hal_adc.c" 2

static void (* ADC_INTERRUPTHANDLER) (void);
void ADC_handeler_funvtion (void);
static __attribute__((inline)) void adc_channel_port_confige(const ADC_CHANNAL_SELECT_t ADC_CHANNAL_SELECT);
static __attribute__((inline)) void select_result_format(const ADC_conf_t *ADC_conf);
static __attribute__((inline)) void configure_voltage_ref(const ADC_conf_t *ADC_conf);
...
Std_ReturnType ADC_ISconversion_done(const ADC_conf_t *ADC_conf , uint8 *conversion_status){
     Std_ReturnType ret =(Std_ReturnType)0x00;
    if ((((void*)0) == ADC_conf) || (((void*)0) == conversion_status)){
        ret =(Std_ReturnType)0x00;
    }
    else{
...
Std_ReturnType ADC_ISconversion_result(const ADC_conf_t *ADC_conf , adc_result_t *conversion_result){
     Std_ReturnType ret =(Std_ReturnType)0x00;
    if ((((void*)0) == ADC_conf) || (((void*)0) == conversion_result)){
        ret =(Std_ReturnType)0x00;
    }
    else{
        if(ADC_conf->result_format == 1){
            *conversion_result = ((ADRESH << 8) + ADRESL);
        }else if(ADC_conf->result_format == 0){
