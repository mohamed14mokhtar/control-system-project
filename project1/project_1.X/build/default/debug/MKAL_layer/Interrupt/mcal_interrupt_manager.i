# 1 "MKAL_layer/Interrupt/mcal_interrupt_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MKAL_layer/Interrupt/mcal_interrupt_manager.c" 2
...
# 12 "MKAL_layer/Interrupt/mcal_interrupt_manager.h"
...
# 12 "MKAL_layer/Interrupt/mcal_interrupt_manager.h" 2
...
# 8 "MKAL_layer/Interrupt/mcal_interrupt_manager.c" 2



static uint8 flag1 = 1,flag2 = 1,flag3 = 1,flag4 = 1;
# 153 "MKAL_layer/Interrupt/mcal_interrupt_manager.c"
    void __attribute__((picinterrupt(("")))) interrupt_manager(void){

        if((1 == INTCONbits.INT0IF) && (1 == INTCONbits.INT0IF)){
            INT0_ISR();
        }
        else{ }
        ...
        if((1 == PIE2bits.BCLIE) && (1 == IPR2bits.BCLIP)){
            MSSP_I2C_BC_ISR();
        }
        else{ }
